...
class dbmanager:
    def __init__(self):
        ...
        self.conn.row_factory = sqlite3.Row #Added this line so values can be accessed by column name
    ...
    def insert_examples(self):
        ...
        self.add_user("louis.parlant.16@ucl.ac.uk", "Louis", "Parlant", 1, "maths")
        self.add_classroom("martin.benning@ucl.ac.uk", "Design and Professional Skills")
        self.add_classroom("louis.parlant.16@ucl.ac.uk", "Introductory Maths to Computer Science")
