                        ...
                        <tbody>
                            {students.map((student, index) => (
                                <tr key={index} className={index % 2 === 0 ? "bg-black" : "bg-gray"}>
                                    <td className="border border-gray-400 px-4 py-2 text-center cursor-pointer hover:bg-blue-700" onClick={() => { handleSubmit(student.user_id)}}>{student.user_id}</td>
                                    <td className="border border-gray-400 px-4 py-2 text-center">{student.first_name ?? "N/A"}</td>
